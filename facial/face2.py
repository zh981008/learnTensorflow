...
def getface(path):
  ...
  classfier = cv2.CascadeClassifier("C:/Users/zh/Desktop/书籍/lab/haarcascade_frontalface_alt2.xml")
  ...
  while suc:
      ...
      if len(faceRects) > 0:          #大于0则检测到人脸
            for faceRect in faceRects:  #单独框出每一张人脸
                ...
                cv2.imwrite('C:/Users/zh/Desktop/书籍/lab/labbb/'+ name +'/%d.jpg' % out_count, img_new, params) #存储到指定目录
                out_count += 1
...
if __name__ == '__main__':
    getface("C:/Users/zh/Desktop/书籍/lab/"+ name +".mp4") #参数为视频地址